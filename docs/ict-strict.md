...
> Versi ICT ketat yang dipertahankan sebagai pembanding. Versi scalper aktif M5/M15 dan perubahan aturannya dijelaskan di [README utama](../README.md).

Strategi dua arah untuk **TradingView, candle standar M1/M5**, dengan setup berurutan, sizing berbasis risiko, dua target, dan dashboard. Salin **seluruh isi [`strategies/ict_strict_v6.pine`](../strategies/ict_strict_v6.pine)** ke Pine Editor, bukan potongan kode dari README ini.
